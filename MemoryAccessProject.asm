...
#a3 = VMT page size
	...
	#load address of seg and vmt
	lh $t0, SEG_TABLE_SIZE 
	lh $t1, VMT_SIZE
	la $t6, SEG_TABLE
	la $t7, VMT

	#ask for target segment
	li $v0, 4
	la $a0, STR_MESSAGE1 
	syscall
	...
	move $a1, $v0	#a1 is target segment
	...
	move $a2, $v0 	#a2 is target offset
...
summary:
	...
	###DISPLAY TARGET SEG NUM MSG
	li $v0, 4
	la $a0, STR_MESSAGE1 
	syscall

	###DISPLAY TARGET SEG NUM
	li $v0, 1 
	move $a0, $a1
	syscall
